...
public class NotesListAdpater extends RecyclerView.Adapter<NotesViewHolder>{
    Context context;
    List<Notes> list;
    NotesClickListener listener;

    public NotesListAdpater(Context context, List<Notes> list, NotesClickListener listener) {
